...
<html lang="en">
  ...
  <head>
    <!-- You may use font awesome icons or Google icons -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="author" content="">

    <title>Resume - Marco Gonzalez</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">Marco Gonzalez</span>
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/marco.png" alt="">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Marco
            <span class="text-primary">Gonzalez</span>
          </h1>
          ...
          <div class="social-icons">
            ...
            <a href="https://www.facebook.com/profile.php?id=100007269614666">
        ...
        <div class="my-auto">
          ...
          <ul class="fa-ul mb-0">
            <li>
              ...
              Ford Family Founcation Scholar</li>
            <li>
              <i class="fa-li fa fa-trophy text-warning"></i>
              Hispanic Metropolitan Scholar</li>
            <li>
              <i class="fa-li fa fa-trophy text-warning"></i>
